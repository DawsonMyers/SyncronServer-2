...
public class TronClockDemo extends Application {
	static              String           nameId = TronClockDemo.class.getSimpleName();
	public final static org.slf4j.Logger log    = org.slf4j.LoggerFactory.getLogger(nameId);
	private             Color            BLUE1  = Color.BLUE;
	private             Color            BLUE2  = Color.ALICEBLUE;
	private             Color            GREEN1 = Color.CORNFLOWERBLUE;
	private             Color            RED1   = Color.FIREBRICK;

	public TronClockDemo() {}
	...
	public void start(final Stage primaryStage) {
		...
		new AnimationTimer() {
			...
			public void handle(long now) {
				...
				gc.translate(blueClock.maxDiameter + 10, 0);
				greenClock.draw(gc);
